...
public class Inverse_Multiplication {
    ...
    public static int getIndex(char x){
        ...
        String y="";
        y+=x;
        int output=Integer.parseInt(y,16);
    ...
    public static void main(String[] args) {
        ...
        int col=getIndex(input.charAt(1));
        
               String mul = R[row][col];
